...
export const availableSpaces: AvailableSpace[] = [
  {
    ...
    images: [
      ...
      { src: "/images/spaces/1202-N-Camp/boxing-concept.jpg", label: "Boxing Gym Concept" },
      { src: "/images/spaces/1202-N-Camp/yoga-concept.jpg", label: "Yoga Studio Concept" },
      { src: "/images/spaces/1202-N-Camp/icecream-concept.jpg", label: "Ice Cream Shop Concept" },
    ]
  },
  {
    ...
    images: [
      ...
      { src: "/images/spaces/1204-N-Camp/event-concept.jpg", label: "Event Space Concept" },
      { src: "/images/spaces/1204-N-Camp/pizza-concept.jpg", label: "Pizza Restaurant Concept" },
    ]
  },
  {
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/images/spaces/The-Silos/food-concept.jpg", label: "Food Hall Concept" },
    ]
  }
];
